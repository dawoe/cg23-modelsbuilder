...
{
    public class CodegardenModelsTextWriter : Builder
    {
        ...
        public CodegardenModelsTextWriter(ModelsBuilderSettings config, IList<TypeModel> typeModels)
            : base(config, typeModels)
        {
        }

        // internal for unit tests only
        public CodegardenModelsTextWriter()
        {
        }
        ...
        public static void WriteHeader(StringBuilder sb) => CodegardenModelsTextHeaderWriter.WriteHeader(sb);
        ...
        private void WriteProperty(StringBuilder sb, TypeModel type, PropertyModel property, string? mixinClrName = null)
        {
            ...
            else
            {
                ...
                if (property.ClrTypeName == "System.String")
                {
                    sb.AppendFormat(
                        " {0} => \"Welcome to codegarden 23\";",
                        property.ClrName);
                }
                else
                {
